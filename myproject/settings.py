...
INSTALLED_APPS = [
    ...
    'MoxBet.apps.MoxbetConfig',
    'rest_framework',
    "channels",
]

ASGI_APPLICATION = "MoxBet.asgi.application"

AUTH_USER_MODEL= 'MoxBet.User'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'MoxBet.context_processors.global_user_data',
            ],
        },
    },
]
...
# Industry-standard storage (hashed, compressed)
